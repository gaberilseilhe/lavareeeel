...
Route::get('/create-usuario', [//nome do que vai vim depois do '/' de agendamento_sistem na url
    UserController::class,  // nome da classe
    'createUsuario'//nome da função em UserController
]); 
